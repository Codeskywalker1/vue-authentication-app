<template>
  <div class="alimentos">
    ...
    <section>
      <h1 id="titulo">Agregar Alimento</h1>
      <div class="cuadro2">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <select id="alimento-type" v-model="categoria" required>
                ...
                <option value="CerealesTuberculos">Cereales y tubérculos</option>
                <option value="CerealesTuberculosGrasa">Cereales y tubérculos con grasa</option>
                ...
                <option value="LipidosProteinas">Lípidos (grasas con proteínas)</option>
    ...
    <section>
      <h1 id="titulo">alimentos guardados</h1>
      <div>
        <div class="busqueda">
        ...
        <table class="tabla-alimentos">
          ...
          <tbody>
            <tr v-for="(alimento, index) in alimentosFiltrados" :key="index">
              ...
              <td>
                <button @click="eliminarAlimento(alimento)">Eliminar</button>
              </td>
            </tr>
          </tbody>
        </table>
  ...
  methods: {
    async agregarAlimento() {
      try {
        ...
        await setDoc(doc(db, "alimentos", this.nombre), {
          nombre: this.nombre,
